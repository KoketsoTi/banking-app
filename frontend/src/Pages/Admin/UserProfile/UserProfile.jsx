...
function UserProfile() {
        ...
        customer_id:{
          data:{
            attributes:{
              age: 29,
              city: "Pretoria",
              createdAt: "2023-01-19T06:34:21.790Z",
              email: "anyastark@gmail.com",
              firstname: "Anya",
              lastname: "Stark",
              phone: "071-425-6742",
              street_address: "17 Tladi Street",
              surbub: "Saulsville",
              updatedAt: "2023-01-23T07:17:12.374Z",
              zipcode: "0125"
            }
          }
        }
  ...
  function getAllUsers(){
    UserService.getUser(state.params.attributes.customer_id.data.id).then((response) => {
