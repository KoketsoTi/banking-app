            ...
            <Box className="card-request mt-10 lg:xl:mt-10">
              <div className="card p-4 lg:xl:p-0" >
                <div className="flex justify-between">
                  ...
                  {loans.length !== 0 ?
                    <button onClick={changeLength} className="rounded-none bg-white add-savings cursor-pointer relative flex py-4 px-4 border border-transparent text-sm font-medium rounded-md text-black ">
